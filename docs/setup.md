...
2. From the list of solution pack that appears, search for and select **Sankey Visualizer**.
3. Click the **Sankey Visualizer** solution pack card.
...
Sankey Visualizer Solution Pack uses the SOC Overview Sankey Widget.
